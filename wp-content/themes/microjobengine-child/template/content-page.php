...
<div class="banner">
    <div class="container">
        <div class="search-slider float-center job-items-title">
            ...
            <a href="<?php echo $post_link; ?>" class="btn-post hvr-sweep-to-left waves-effect waves-light"><p class="name-button-post"><?php _e('Post Your Service', 'enginethemes'); ?></p> <span class="cirlce-plus"><i class="fa fa-plus"></i></span></a>
        </div>
    </div>
