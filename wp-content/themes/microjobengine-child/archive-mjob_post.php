            ...
            <div class="container">
                <h2 class="block-title">
                    <p class="block-title-text" data-prefix="<?php _e('in', 'enginethemes'); ?>">
                        ...
                        if($search_result == 1) {
                            printf(__('<span class="search-result-count">%s</span> <span class="search-text-result">SERVICE AVAILABLE</span>', 'enginethemes'), $search_result);
                        } else {
                            printf(__('<span class="search-result-count">%s</span> <span class="search-text-result">SERVICES AVAILABLE</span>', 'enginethemes'), $search_result);
                        }
