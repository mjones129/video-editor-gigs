                        ...
                        <div class="information-items-detail box-shadow">
                            <div class="tabs-information">
                                <div class="link-post-job">
                                    ...
                                    ?>
                                    <a href="<?php echo $post_link ?>" class="post-job-button"><span class="text-post"><?php _e('Post Your Service', 'enginethemes'); ?></span>
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#job" aria-controls="job" role="tab" data-toggle="tab"><?php _e('My Servies', 'enginethemes'); ?></a></li>
                                </ul>
                                <div class="tab-content">
