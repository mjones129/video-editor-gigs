            ...
            <div class="container">
                <h2 class="block-title">
                    <span class="block-title-text" data-prefix="<?php _e('in', 'enginethemes'); ?>">
                        ...
                        if($search_result == 1) {
                            printf(__('<span class="search-result-count">%s</span> <span class="search-text-result">SERVICE AVAILABLE', 'enginethemes'), $search_result);
                        } else {
                            printf(__('<span class="search-result-count">%s</span> <span class="search-text-result">SERVICES AVAILABLE', 'enginethemes'), $search_result);
                        }
                        ?>
                    </span>
                    ...
                    <div class="show-filter-wrap hidden-lg hidden-md">
                        <a class="filter-open-btn" href=""><?php _e('FILTER GIGS', 'enginethemes'); ?> <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                    </div>
                        ...
                        <div class="mje-col-left-wrap">
                            <div class="mje-col-left">
                                ...
                                <div class="hidden-lg hidden-md">
                                     <a class="clear-filter-btn" href= "<?php echo get_post_type_archive_link('mjob_post');?> "><?php _e('CLEAR ALL FILTERS', 'enginethemes'); ?></a>
                                </div>
                                <div class="hidden-lg hidden-md">
                                    <?php get_template_part('template/sort', 'template'); ?>
                                </div>
