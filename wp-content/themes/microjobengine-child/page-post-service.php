...
<div id="content" class="mjob-post-service">
    <div class="container float-center">
        <p class="block-title"><?php _e('POST YOUR SERVICE', 'enginethemes'); ?></p>
        ...
        if(! $user_ID) {
            ...
            echo '<p class="not-found">' . __( 'Your account is pending.<br />Please check your email and confirm your account before posting the Gig.', 'enginethemes' ) . '</p>';
        } else {
